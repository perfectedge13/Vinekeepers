...
| `com.vinekeepers.connectors` | Event sources (e.g. GitHub, Discord); JDA-backed Discord gateway (`createTextChannel` for lifecycle rooms); `DiscordReplySender` (legacy) and `DiscordAppReplySink` for workflow replies and rich interactions |
