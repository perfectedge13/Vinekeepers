...
| `com.vinekeepers.bot` | Bot definitions, `RuntimeBotInstance` (provisioned per-channel from template, e.g. Arrietty), conversation/runtime options, normalized routing, persona |
