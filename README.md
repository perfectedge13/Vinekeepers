...
- `CURSOR_MODEL`: fallback Cursor model id when launch resolution finds no model from the workflow step, `call_action` bind (`cursorModel` / `model`), or bot `persona.model`
