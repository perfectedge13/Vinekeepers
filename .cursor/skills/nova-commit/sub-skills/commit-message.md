...
**Purpose:** Define formatting and rules for commit messages produced by the nova-commit workflow. Used by the commit-push step when composing the message for `git commit -m "..."`.
