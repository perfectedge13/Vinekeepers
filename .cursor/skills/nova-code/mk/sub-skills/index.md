...
3. For each file in order:
   - **&lt;docs_dir&gt;/index.md** — Ensure exists. Content: H1 &lt;project name from config or registry&gt;, # Overview (project summary from README or specs), # Quick links (bulleted links to [Features](features/index.md), [Architecture](architecture.md), [Runbooks](runbooks/index.md), [Cursor](cursor/index.md)). Write or overwrite the file.
