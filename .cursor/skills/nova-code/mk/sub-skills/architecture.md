...
**Outputs:** File `<docs_dir>/architecture.md` created or updated. Pass/Fail and short description.
...
3. Create the configured **docs dir** if it does not exist. Write or overwrite `<docs_dir>/architecture.md` with the formatted body (markdown; use a Mermaid code block in the Diagram section if desired).
