...
**Outputs:** Files created or updated: `<docs_dir>/runbooks/index.md`, `<docs_dir>/runbooks/operational.md`, `<docs_dir>/runbooks/troubleshooting.md`, `<docs_dir>/runbooks/recovery.md`, `<docs_dir>/runbooks/maintenance.md`. Pass/Fail and count.
...
3. For each file:
   - **`<docs_dir>/runbooks/index.md`** — Ensure exists. Content: # Runbooks, # Index (links to operational, troubleshooting, recovery, maintenance), short intro. Write or overwrite.
