...
| ASSET-POST-PLANNING-PROGRESS-IF-CHANGED-ACTION | post_planning_progress_if_changed — posts the **Planning cycle** line only when **planningProgressPostWorthy** is true (fingerprint differs from **planningLastProgressPostHash**); otherwise spreads **planningProgressPostSkipped** without sending | src/main/java/com/vinekeepers/workflow/actions/PostPlanningProgressIfChangedAction.java |
