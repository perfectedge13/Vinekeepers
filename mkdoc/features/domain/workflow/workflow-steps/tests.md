...
| UNIT-OPENAI-CHAT-CLIENT-ERROR | OpenAiChatClientTest | com.vinekeepers.connectors.openai.OpenAiChatClientTest | completeReturnsNonBlankErrorWhenExceptionMessageIsNull | Verify OpenAI client returns non-blank ERROR line when send throws with null message |
