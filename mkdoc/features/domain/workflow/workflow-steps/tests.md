...
| UNIT-PLAN-READINESS-CALCULATOR | PlanReadinessCalculatorTest | com.vinekeepers.workflow.planreview.PlanReadinessCalculatorTest | — | Verify readiness/confidence from governance, findings, rubric, packet; known-vs-unknown tallies |
| UNIT-PLANNING-APPROVAL-GATE-SUPPORT | PlanningApprovalGateSupportTest | com.vinekeepers.workflow.planreview.PlanningApprovalGateSupportTest | — | Verify validateApproveAllowed blocks approval when confidence is below APPROVAL_CONFIDENCE_THRESHOLD (0.85) |
| UNIT-PLANNING-POST-DRAFT-GOVERNOR | PlanningPostDraftGovernorTest | com.vinekeepers.workflow.planning.PlanningPostDraftGovernorTest | — | Verify post-draft action including ASK_ONE_QUESTION when material gaps remain |
| UNIT-PLANNING-CYCLE-PIPELINE-CANONICAL-CLARIFICATION | PlanningCyclePipelineCanonicalClarificationTest | com.vinekeepers.workflow.planning.PlanningCyclePipelineCanonicalClarificationTest | — | Verify canonical_v1 clarification gating and planningPostDraftAction spread |
