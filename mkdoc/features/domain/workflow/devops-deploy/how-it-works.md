...
- **Inputs:** Discord message (mention + channel), deploy target manifest (`config/deploy-targets.yaml` or env override), optional git remote for branch list, env toggles for Ansible/host ops and paths.
