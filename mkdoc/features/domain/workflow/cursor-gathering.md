...
| ASSET-LIFECYCLE-CONTEXT | Lifecycle run context (channelId, externalRunId, configuredBotId, runtimeBotInstanceId, optional repo/requestText, optional deliveryChannelId) for Phase 1 lifecycle room | src/main/java/com/vinekeepers/state/LifecycleContext.java |
