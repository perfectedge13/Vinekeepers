...
| UNIT-CURSOR-ADAPTER-EXCEPTION | transportExceptionSurfacesMessage | com.vinekeepers.core.cursor.CursorCloudAdapterImplTest | transportExceptionSurfacesMessage | Verify transport exceptions surface message to caller |
