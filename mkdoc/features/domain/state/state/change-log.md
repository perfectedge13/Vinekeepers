...
- **CLARIFYING intake with ASK_USER:** Documented that **FeaturePlanState** / planning room cycle may persist **PlanningIntakeStage.CLARIFYING** when the canonical decision resolves **ASK_USER** and intake was not already clarifying. Specs: **state-registry**, **workflow-registry**; tests: **PlanningCyclePipelineCanonicalClarificationTest**.
