...
| ASSET-FEATURE-PLAN-STATE | Canonical structured planning state for a feature room (legacy sections, workspace linkage, profileId, artifacts map; planner recovery fields; coordinatorConfiguredBotId) | src/main/java/com/vinekeepers/state/planning/FeaturePlanState.java |
