...
Reply delivery goes through **OutboundDeliveryRouter**. The router implements the generic **ReplySender** contract (Discord uses **DiscordReplySender**, which extends it) and resolves which sender (gateway + token) to use:
