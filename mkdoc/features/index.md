...
A feature is a cohesive capability backed by spec requirements and traced assets. Feature pages summarize behavior, contracts, tests, and operational notes for one capability. Status is recorded as **draft**, **active**, or **deprecated**.
...
| Events | Internal event bus and event contracts | [Events](domain/events.md) |
| State | Persisted per-bot conversational workflow state | [State](domain/state.md) |
| Tools | Tool registration and policy-gated execution | [Tools](domain/tools.md) |
