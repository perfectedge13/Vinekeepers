...
- [Events](domain/events.md) — Event bus and event payload contracts
- [State](domain/state.md) — Persisted workflow state per bot and conversation
- [Tools](domain/tools.md) — Tool registration and policy-gated execution
