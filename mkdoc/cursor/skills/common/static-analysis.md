...
- Command from specs validation.commands.static_analysis or project.yml validation_defaults.static_analysis. Run from project root (shell-safe: Set-Location on PowerShell, no `&&`).
