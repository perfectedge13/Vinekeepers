...
Runs the **scan-and-update** workflow. Orchestrator follows scan-and-update.md: scan repo, infer domains, categorize features, update specs index and registries, write spec files, sync the configured docs dir (including Cursor docs), and return a report per output-format.md.
...
- [sub-skills/scan-output](nova-spec/sub-skills/scan-output.md)
...
- [sub-skills/categorize-features-to-domains-output](nova-spec/sub-skills/categorize-features-to-domains-output.md)
- [sub-skills/propose-registry-layout](nova-spec/sub-skills/propose-registry-layout.md)
