...
- **Requirement plausibility table** — For each requirement (or summary): Implemented? true/false, brief justification; note any active requirement that is false (and any issue raised).
