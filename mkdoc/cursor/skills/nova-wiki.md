...
Runs the **Wiki.js sync** workflow. Orchestrator launches one sub-agent per step: wiki_prepare, wiki_index, wiki_architecture, wiki_runbooks, wiki_feature_dossiers. Uses auth from .env (WIKIJS_*); skip if not set.

## Key points

- Workflow in **nova-wiki.yml**; page formats and auth in **page-formats.md** and **auth.md**.
- Handoff from nova-code must include plan_change and implement so prepare can compute affected_features.

## Sub-skills

- [auth](nova-wiki/auth.md)
- [sub-skills/prepare](nova-wiki/sub-skills/prepare.md)
- [sub-skills/index](nova-wiki/sub-skills/index.md)
- [sub-skills/architecture](nova-wiki/sub-skills/architecture.md)
- [sub-skills/runbooks](nova-wiki/sub-skills/runbooks.md)
- [sub-skills/feature-dossiers](nova-wiki/sub-skills/feature-dossiers.md)
