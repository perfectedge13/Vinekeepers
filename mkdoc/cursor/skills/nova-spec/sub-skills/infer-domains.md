...
From candidate features (suggested_domain) and existing registries, outputs list of { domain_slug, registry_file, exists }. First-class domain: connectors; all others map to core.

## Key points

- See **.cursor/skills/nova-spec/sub-skills/infer-domains.md** for full instructions.
