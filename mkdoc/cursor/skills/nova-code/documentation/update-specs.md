...
Updates requirements, validation tests, traceability, acceptance, assets, dependencies, and interfaces/change_triggers within existing schema keys. When something didn't work, add to anti_patterns.

## Key points

- Schema-only keys; no new keys. See **.cursor/skills/nova-code/documentation/update-specs.md** for full instructions.
