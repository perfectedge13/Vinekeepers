...
Builds a reference map across index, registries, and README for removal/rename; apply step updates all references; verify no dangling refs.

## Key points

- Run when branch_removal_rename is taken (plan_change set removal_or_rename).
- See **.cursor/skills/nova-code/implementation/removal-rename.md** for full instructions.
